  ...
  <div className="flex flex-col w-full h-full bg-[#101419] border border-gray-800 items-center rounded-xl">
    ...
    {type !== "approval" ? (
      <div className="justify-center flex flex-row items-center w-full">
        ...
        <p className="font-['Archivo'] font-bold text-[18px] pt-2 pl-1">
          {values?.[0]} {tokenLabels?.[0]}
        </p>
        <img src="arrow_right.svg" alt="rarrow" className="px-2 mt-1"/>
        <p className="font-['Archivo'] font-bold text-[18px] pt-2 pr-1">
          {values?.[1]} {tokenLabels?.[1]}
        </p>
        <img src={tokenIcons?.[1]} alt="vusdicon" />
      </div>
    ) : (
      <div className="justify-center flex flex-row w-full">
        <p className="font-['Archivo'] font-bold text-[18px] pt-2">
          Contract Approval
        </p>
      </div>
    )}
